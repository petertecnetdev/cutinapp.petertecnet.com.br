...
export default function MessagesPage() {
  ...
  const startChat = async (person) => {
    try {
      ...
      setNewChatOpen(false); setPeopleQuery(""); await loadConversations(""); setActive(conversation);
