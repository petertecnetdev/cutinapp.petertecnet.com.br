...
export default function ArtistListPage() {
  ...
  return <div className="cut-app-page">
    ...
    <Container className="cut-page-container py-4 py-lg-5">
      ...
      <div className="cut-discovery-primary mb-4"><Form.Control placeholder="Buscar artista ou banda" value={q} onChange={(e) => update("q", e.target.value)} /><Form.Control placeholder="Cidade" value={city} onChange={(e) => update("city", e.target.value)} /></div>
