        ...
        {form && <Form onSubmit={submit} noValidate>
          ...
          <div className="mt-4">
            <AmbientMusicSettings
              subjectType="event"
              subjectId={Number(id)}
              recommendationSubjectType="organization"
              recommendationSubjectId={Number(eventData?.production_id || form.production_id || 0) || null}
              allowInheritance
            />
          </div>
        </Form>}
