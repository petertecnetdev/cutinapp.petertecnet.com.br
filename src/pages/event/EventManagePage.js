...
export default function EventManagePage() {
  ...
  const processingLabel = loading ? "Carregando eventos" : "Atualizando evento";
          ...
          <Row className="g-4">{events.map((event) => {
            ...
            return <Col lg={6} key={event.id}><Card className="cut-panel h-100"><Card.Body className="p-4">
              ...
              <div className="cut-card-actions mt-4">
                ...
                <Button variant="outline-light" onClick={() => navigate(`/event/duplicate/${event.id}`)} disabled={Boolean(busyId)}><i className="fa-regular fa-copy me-2" />Duplicar</Button>
