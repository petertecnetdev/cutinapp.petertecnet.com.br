...
export default function ProductionPublicPage() {
  ...
  return <div className="cut-app-page"><NavlogComponent />
    ...
    <Container className="cut-page-container py-5">{error && <Alert variant="danger">{error}</Alert>}
      ...
      <div className="mb-5"><SocialThread scopeType="production" scopeId={production.id} eyebrow="Comunidade da produção" title={`Converse sobre ${production.name}`} description="Pergunte sobre próximos eventos, combine rolês, conte como foi sua experiência e converse com quem acompanha esta produção." /></div>
