...
export default function ProducerContractsPage() {
  ...
  return <div className="cut-app-page">
    ...
    <Container className="cut-page-container py-4 py-lg-5">
      <div className="cut-page-heading"><div><span className="cut-eyebrow">Área do produtor</span><h1>Contrato do produtor</h1><p>Leia e assine o termo vigente para habilitar vendas de ingressos pagos. A produção e os eventos podem ser preparados antes da assinatura.</p></div></div>
