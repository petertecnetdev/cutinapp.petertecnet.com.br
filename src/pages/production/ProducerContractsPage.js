...
export default function ProducerContractsPage() {
  ...
  return <div className="cut-app-page">
    ...
    <Container className="cut-page-container py-4 py-lg-5">
      <div className="cut-page-heading"><div><span className="cut-eyebrow">Área do produtor</span><h1>Contrato do produtor</h1><p>Você pode preparar seus eventos desde já. Assine o termo vigente antes de publicar e iniciar as vendas.</p></div></div>
