...
const cutinappService = {
  ...
  publicEventAnnouncements: async (slug) => (await appApiClient.get(`/events/public/${slug}/announcements`)).data,
  manageEventAnnouncements: async (eventId) => (await appApiClient.get(`/events/${eventId}/announcements/manage`)).data,
  createEventAnnouncement: async (eventId, payload) => (await appApiClient.post(`/events/${eventId}/announcements`, payload)).data,
  updateEventAnnouncement: async (eventId, announcementId, payload) => (await appApiClient.patch(`/events/${eventId}/announcements/${announcementId}`, payload)).data,
  publishEventAnnouncement: async (eventId, announcementId) => (await appApiClient.post(`/events/${eventId}/announcements/${announcementId}/publish`)).data,
  unpublishEventAnnouncement: async (eventId, announcementId) => (await appApiClient.post(`/events/${eventId}/announcements/${announcementId}/unpublish`)).data,
  deleteEventAnnouncement: async (eventId, announcementId) => (await appApiClient.delete(`/events/${eventId}/announcements/${announcementId}`)).data,
