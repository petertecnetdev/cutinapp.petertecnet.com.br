...
const cutinappService = {
  ...
  timeline: async (params = {}) => (await appApiClient.get("/timeline", { params })).data,
  createTimelinePost: async (formData) => (await appApiClient.post("/timeline/posts", formData)).data,
  deleteTimelinePost: async (postId) => (await appApiClient.delete(`/timeline/posts/${postId}`)).data,
  commentTimelinePost: async (postId, payload) => (await appApiClient.post(`/timeline/posts/${postId}/comments`, payload)).data,
  reactTimelinePost: async (postId, reaction = "like") => (await appApiClient.put(`/timeline/posts/${postId}/reaction`, { reaction })).data,
  unreactTimelinePost: async (postId) => (await appApiClient.delete(`/timeline/posts/${postId}/reaction`)).data,
  saveTimelinePost: async (postId) => (await appApiClient.put(`/timeline/posts/${postId}/save`)).data,
  unsaveTimelinePost: async (postId) => (await appApiClient.delete(`/timeline/posts/${postId}/save`)).data,
  shareTimelinePost: async (postId, payload = {}) => (await appApiClient.post(`/timeline/posts/${postId}/share`, payload)).data,
  voteTimelinePoll: async (postId, optionId) => (await appApiClient.post(`/timeline/posts/${postId}/vote`, { option_id: optionId })).data,
  reportTimelinePost: async (postId, payload) => (await appApiClient.post(`/timeline/posts/${postId}/report`, payload)).data,
  trackTimelinePost: async (postId, eventType, sessionKey) => (await appApiClient.post(`/timeline/posts/${postId}/track`, { event_type: eventType, session_key: sessionKey })).data,
  timelineAnalytics: async () => (await appApiClient.get("/timeline/analytics")).data,
  requestTimelineBoost: async (postId, payload) => (await appApiClient.post(`/timeline/posts/${postId}/boosts`, payload)).data,
  timelineModerationReports: async (params = {}) => (await appApiClient.get("/timeline/moderation/reports", { params })).data,
  moderateTimelineReport: async (reportId, payload) => (await appApiClient.put(`/timeline/moderation/reports/${reportId}`, payload)).data,
