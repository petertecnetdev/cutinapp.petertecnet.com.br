...
const commerceService = {
  ...
  createCoupon: async (organizationId, payload = {}) => (await appApiClient.post(`/organizations/${Number(organizationId)}/coupons`, payload)).data.coupon,
  updateCoupon: async (organizationId, couponId, payload = {}) => (await appApiClient.patch(`/organizations/${Number(organizationId)}/coupons/${Number(couponId)}`, payload)).data.coupon,
  disableCoupon: async (organizationId, couponId) => (await appApiClient.delete(`/organizations/${Number(organizationId)}/coupons/${Number(couponId)}`)).data,
